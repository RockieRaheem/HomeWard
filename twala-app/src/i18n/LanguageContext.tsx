...
const LUGANDA: Record<string, string> = {
  ...
  'Enter PIN': 'Wandiika PIN', 'Checking account…': 'Tukebera akawunti…', 'Invalid PIN': 'PIN si ntuufu', 'Create a 4-6 digit PIN.': 'Tonda PIN ey’ennamba 4-6.',
  'Phone Required': 'Essimu yeetaagisa', 'Enter your mobile money phone number.': 'Wandiika namba yo eya Mobile Money.', 'Enter a valid phone number (e.g. +256712345678).': 'Wandiika namba y’essimu entuufu (nga +256712345678).',
  'Name Required': 'Erinnya lyetaagisa', 'Enter your full name.': 'Wandiika amannya go amatuufu.', 'Something went wrong. Try again.': 'Wabaddemu kiremya. Ddamu ogezeeko.',
  'Connection error. Check that the backend is running.': 'Omukutu gugaanye. Kebera oba backend etandise.',
  'PIN Mismatch': 'PIN tezifaanagana', 'PINs do not match.': 'PIN zo tezifaanagana.', 'PIN Required': 'PIN yeetaagisa', 'Enter your PIN to log in.': 'Wandiika PIN yo oyingire.',
  ...
  'AVAILABLE TO SEND': 'SSENTE EZIRIWO OKUWEEREZA', 'USDC': 'USDC', 'Send money': 'Weereza ssente', 'Cash in': 'Tekako sente', 'Ask HomeWard': 'Buuza HomeWard', 'Circles': 'Ebibiina',
  ...
  'Smart Transfer': 'Okuweereza ssente mu magezi', 'Send': 'Weereza', 'Deposit': 'Tekako sente', 'Live': 'Kiriwo kakano', 'You Send': 'Ky’oweereza',
